...
public class SPUtil {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "com.android.smsutil_preferences";
     ...
     * 声音提示
     */
    public static final String VOICE_POINT = "VOICE_POINT";
     ...
     * @return
     */
    public synchronized static Object get(Context context, String key, Object defaultObject) {
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
